...
const renderPlayPauseIcon = (isPlaying) => {
    if (isPlaying) {
        return <MaterialCommunityIcons name="pause" size={24} color="white" />;
    } else {
        return <MaterialCommunityIcons name="play" size={24} color="white" />;
    }
};
                ...
                <TouchableWithoutFeedback onPress={onAudioPress}>
                    <View className="flex-row w-[85%]">
                        ...
                        <View className="flex-col flex-1">
                            <Text
                                numberOfLines={1}
                                className="text-secondary font-scBold"
                            >
                                {title}
                            </Text>
                            <Text className="text-quaternary font-scRegular">
                                {duration}
                            </Text>
                        </View>
                    </View>
